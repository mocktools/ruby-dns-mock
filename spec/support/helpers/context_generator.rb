  ...
  module RspecHelper
    module ContextGenerator
      ...
      def random_non_ascii_hostname
        "#{DnsMock::RspecHelper::ContextGenerator::NON_ASCII_WORDS.sample}#{random_hostname}"
      end
      ...
      def create_records(hostname = DnsMock::RspecHelper::ContextGenerator.random_hostname, *records, **options) # rubocop:disable Metrics/MethodLength)
